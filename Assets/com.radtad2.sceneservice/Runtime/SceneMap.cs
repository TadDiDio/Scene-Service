    ...
    public class SceneMap : ScriptableObject
    {
        ...
        public static SceneMap Active
        {
            get
            {
                ...
                _cached = Resources.FindObjectsOfTypeAll<SceneMap>().FirstOrDefault();
#endif
            
                if (!_cached) throw new InvalidOperationException("SceneService: No active SceneMap loaded. Make sure to set one in Tools -> Scene Map Settings");
